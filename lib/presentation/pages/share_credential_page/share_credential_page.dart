...
class ShareCredentialPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final showHeader = ref.watch(
      controllerProvider.select((s) =>
          s.stage is StageAwaitingProfile ||
          s.stage is StageMatchingCredentials ||
          s.stage is StageMatchFailed ||
          s.stage is StageReadyToShare ||
          s.stage is StageSubmitting ||
          s.stage is StageSubmitFailed),
    );
    ...
    return Scaffold(
      ...
      appBar: TdkAppBar(
        ...
        showBackButton: true,
        onBackPressed: () => ref.read(navigationServiceProvider).popOrGoHome(),
      ),
      body: SafeArea(
        child: Padding(
