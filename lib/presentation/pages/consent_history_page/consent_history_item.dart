...
class ConsentHistoryItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dateFormatted = _formatDate(record.sharedAt, localizations.consentHistoryNotAvailable);

    return InkWell(
      onTap: () => ConsentHistoryDetailsSheet.show(context: context, record: record),
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(
              icon: const Icon(Icons.more_horiz, color: AppColorScheme.textSecondary),
              onPressed: () => ConsentHistoryDetailsSheet.show(context: context, record: record),
              tooltip: 'Details',
            ),
          ],
        ),
