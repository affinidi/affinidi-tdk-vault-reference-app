...
mixin _$ConsentHistoryPageState {
  ...
  Map<String, String> get profileDidById => throw _privateConstructorUsedError;
...
abstract class $ConsentHistoryPageStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<IotaConsentRecord> records,
...
class _$ConsentHistoryPageStateCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      profileDidById: null == profileDidById
          ? _value.profileDidById
          : profileDidById // ignore: cast_nullable_to_non_nullable
...
class _$ConsentHistoryPageStateImpl implements _ConsentHistoryPageState {
  _$ConsentHistoryPageStateImpl(
      ...
      final Map<String, String> profileDidById = const {},
      this.isLoading = false,
      this.error})
      : _records = records,
        _profileDidById = profileDidById;
  ...
  final Map<String, String> _profileDidById;
  @override
  @JsonKey()
  Map<String, String> get profileDidById {
    if (_profileDidById is EqualUnmodifiableMapView) return _profileDidById;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_profileDidById);
  }
  ...
  @override
  String toString() {
    return 'ConsentHistoryPageState(records: $records, profileDidById: $profileDidById, isLoading: $isLoading, error: $error)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._profileDidById, _profileDidById) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_profileDidById),
      isLoading,
      error);
...
abstract class _ConsentHistoryPageState implements ConsentHistoryPageState {
  factory _ConsentHistoryPageState(
      ...
      final Map<String, String> profileDidById,
      final bool isLoading,
