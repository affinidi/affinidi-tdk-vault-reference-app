...
part of 'claim_credentials_page_state.dart';
...
class _$ClaimCredentialsPageStateImpl extends _ClaimCredentialsPageState {
  ...
  @override
  String toString() {
    return 'ClaimCredentialsPageState(claimContext: $claimContext, verifiableCredential: $verifiableCredential, offerUri: $offerUri, profileId: $profileId, fetchStatus: $fetchStatus, fetchErrorMessage: $fetchErrorMessage)';
  }
