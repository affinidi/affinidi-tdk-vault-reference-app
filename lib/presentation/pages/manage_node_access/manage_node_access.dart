...
import 'manage_node_access_provider.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> revokeAccess(String granteeDid) async {
      ...
      try {
        ...
        // Optimistically update the cache and then refresh.
        accessNotifier.removeFromCache(granteeDid);
        await accessNotifier.refresh(force: true);
        if (context.mounted) {
    ...
    Widget buildTableContent() {
      final data = accessState.asData?.value;
      final isInitialLoading = accessState.isLoading && data == null;
      final isRefreshing = data?.isRefreshing ?? false;
