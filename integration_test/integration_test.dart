    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.enterText(
          find.byKey(Key(KeyConstants.keyEnterDiDTextField)),
          did,
        );
        await tester.pumpAndSettle();
...
Future<void> _createVaultHelper(
  ...
  if (seedMode == SeedMode.useExisting) {
    await tester.tap(
      find.byKey(Key('${KeyConstants.keyRadio}_${seedMode?.name}')),
    );
    await tester.pumpUntilFound(
      find.bySemanticsLabel(localizations.enterSeedHint),
    );
    await tester.enterText(
      find.bySemanticsLabel(localizations.enterSeedHint),
...
Future<void> _renameFileOrFolder({
  ...
  await tester.pumpAndSettle();
  await tester.enterText(
    find.byKey(Key(KeyConstants.keyRenameTextField)),
    newFileName,
  );
